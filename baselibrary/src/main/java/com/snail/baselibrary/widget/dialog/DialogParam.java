...
public class DialogParam {
    ...
    public boolean isNegativeNormal = true;

    public boolean onlyConfirm = false;
    ...
    public static class Builder {
        ...
        private boolean isNegativeNormal = true;
        ...
        public DialogParam build() {
            DialogParam bundle = new DialogParam();
            ...
            bundle.onlyConfirm = this.onlyConfirm;
            bundle.drawableRes = this.drawableRes;
            bundle.editable = this.editable;
            bundle.isCenter = this.isCenter;
            bundle.isNegativeNormal = this.isNegativeNormal;
            return bundle;
        }
         ...
         * 是否只显示确定
         *
         * @param isOnly boolean | true:显示;false:不显示
         * @return Builder
         */
        public Builder onlyConfirm(boolean isOnly) {
            this.onlyConfirm = isOnly;
            return this;
        }
        ...
        public Builder setNegativeNormal(boolean negativeNormal) {
            isNegativeNormal = negativeNormal;
            return this;
        }
    }
}
